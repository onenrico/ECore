...
public class TimeManager {
	...
	public static String formatTime(double second, @Nullable String... args) {
		...
		if (day > 0) {
			build.append(String.valueOf(day) + args[0]);
			build.append(" ");
		}
		if (hour > 0) {
			build.append(String.valueOf(hour) + args[1]);
			build.append(" ");
		}
		if (minute > 0) {
			build.append(String.valueOf(minute) + args[2]);
			build.append(" ");
		}
		if (second > 0L) {
			build.append(String.valueOf(second) + args[3]);
		}
