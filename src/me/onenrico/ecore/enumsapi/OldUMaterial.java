package me.onenrico.ecore.enumsapi;
...
/*
    ...
    You can only find this software at https://gitlab.com/RandomHashTags/EMaterial
...
public enum OldUMaterial {
	/*
	 * <item>(1.8.8, 1.9.4, 1.10.2, 1.11.2, 1.12.2, 1.13.2, 1.14.0) 1.8.8 =
	 * http://docs.codelanx.com/Bukkit/1.8/org/bukkit/Material.html 1.13.2 =
	 * https://hub.spigotmc.org/javadocs/bukkit/org/bukkit/Material.html visual =
	 * https://www.digminecraft.com/lists/item_id_list_pc.php Special blocks =
	 * https://www.planetminecraft.com/blog/secret-blocks-vanilla/
	 */
	...
	AZURE_BLUET(3, "RED_ROSE", null, null, null, null, "AZURE_BLUET"), BAKED_POTATO("BAKED_POTATO"), BARRIER("BARRIER"),
	...
	BLACK_WOOL(15, "WOOL", null, null, null, null, "BLACK_WOOL"), BLAZE_POWDER("BLAZE_POWDER"), BLAZE_ROD("BLAZE_ROD"),
	...
	CACTUS_GREEN(2, "INK_SACK", null, null, null, null, "CACTUS_GREEN"), CAKE("CAKE"),
	CAKE_BLOCK("CAKE_BLOCK", null, null, null, null, "CAKE"), CARROT("CARROT"),
	...
	CONDUIT(null, null, null, null, null, "CONDUIT"), COOKED_BEEF("COOKED_BEEF"), COOKED_CHICKEN("COOKED_CHICKEN"),
	...
	DIORITE(3, "STONE", null, null, null, null, "DIORITE"), DIRT("DIRT"), DISPENSER("DISPENSER"),
	...
	FLINT("FLINT"), FLINT_AND_STEEL("FLINT_AND_STEEL"), FLOWER_POT("FLOWER_POT"),
	FLOWER_POT_ITEM("FLOWER_POT_ITEM", null, null, null, null, "FLOWER_POT"), FROSTED_ICE(null, "FROSTED_ICE"),
	...
	GLASS("GLASS"), GLASS_PANE("THIN_GLASS", null, null, null, null, "GLASS_PANE"), GLASS_BOTTLE("GLASS_BOTTLE"),
	...
	GRANITE(1, "STONE", null, null, null, null, "GRANITE"), GRASS("GRASS"),
	...
	IRON_CHESTPLATE("IRON_CHESTPLATE"), IRON_DOOR("IRON_DOOR"),
	IRON_DOOR_BLOCK("IRON_DOOR_BLOCK", null, null, null, null, "IRON_DOOR"), IRON_HELMET("IRON_HELMET"),
	IRON_HOE("IRON_HOE"), IRON_HORSE_ARMOR("IRON_BARDING", null, null, null, null, "IRON_HORSE_ARMOR"),
	IRON_INGOT("IRON_INGOT"), IRON_LEGGINGS("IRON_LEGGINGS"), IRON_NUGGET(null, null, null, "IRON_NUGGET"),
	IRON_ORE("IRON_ORE"), IRON_PICKAXE("IRON_PICKAXE"),
	IRON_SHOVEL("IRON_SPADE", null, null, null, null, "IRON_SHOVEL"), IRON_SWORD("IRON_SWORD"),
	IRON_TRAPDOOR("IRON_TRAPDOOR"), ITEM_FRAME("ITEM_FRAME"), JACK_O_LANTERN("JACK_O_LANTERN"), JUKEBOX("JUKEBOX"),
	...
	KELP_PLANT(null, null, null, null, null, "KELP_PLANT"), KNOWLEDGE_BOOK(null, null, null, null, "KNOWLEDGE_BOOK"),
	LADDER("LADDER"), LAPIS_BLOCK("LAPIS_BLOCK"), LAPIS_LAZULI(4, "INK_SACK", null, null, null, null, "LAPIS_LAZULI"),
	LAPIS_ORE("LAPIS_ORE"), LARGE_FERN(3, "DOUBLE_PLANT", null, null, null, null, "LARGE_FERN"), LAVA("LAVA"),
	LAVA_BUCKET("LAVA_BUCKET"), LEAD("LEASH", null, null, null, null, "LEAD"), LEATHER("LEATHER"),
	LEATHER_BOOTS("LEATHER_BOOTS"), LEATHER_CHESTPLATE("LEATHER_CHESTPLATE"), LEATHER_HELMET("LEATHER_HELMET"),
	LEATHER_LEGGINGS("LEATHER_LEGGINGS"), LEVER("LEVER"),
	...
	LINGERING_POTION_AWKWARD(
			new EPotion(PotionBase.LINGERING,
					PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "AWKWARD" : "WATER"), false, false),
			0, null, "LINGERING_POTION"),
	LINGERING_POTION_FIRE_RESISTANCE(new EPotion(PotionBase.LINGERING, PotionType.FIRE_RESISTANCE, false, false), 0,
			null, "LINGERING_POTION"),
	LINGERING_POTION_FIRE_RESISTANCE_EXTENDED(
			new EPotion(PotionBase.LINGERING, PotionType.FIRE_RESISTANCE, true, false), 0, null, "LINGERING_POTION"),
	LINGERING_POTION_HARMING_1(new EPotion(PotionBase.LINGERING, PotionType.INSTANT_DAMAGE, false, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_HARMING_2(new EPotion(PotionBase.LINGERING, PotionType.INSTANT_DAMAGE, false, true), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_HEALING_1(new EPotion(PotionBase.LINGERING, PotionType.INSTANT_HEAL, false, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_HEALING_2(new EPotion(PotionBase.LINGERING, PotionType.INSTANT_HEAL, false, true), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_INVISIBILITY(new EPotion(PotionBase.LINGERING, PotionType.INVISIBILITY, false, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_INVISIBILITY_EXTENDED(new EPotion(PotionBase.LINGERING, PotionType.INVISIBILITY, true, false), 0,
			null, "LINGERING_POTION"),
	LINGERING_POTION_LEAPING_1(new EPotion(PotionBase.LINGERING, PotionType.JUMP, false, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_LEAPING_1_EXTENDED(new EPotion(PotionBase.LINGERING, PotionType.JUMP, true, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_LEAPING_2(new EPotion(PotionBase.LINGERING, PotionType.JUMP, false, true), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_LUCK(
			new EPotion(PotionBase.LINGERING,
					!Bukkit.getVersion().contains("1.8") ? PotionType.valueOf("LUCK") : PotionType.WATER, false, false),
			0, null, "LINGERING_POTION"),
	LINGERING_POTION_MUNDANE(
			new EPotion(PotionBase.LINGERING,
					PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "MUNDANE" : "WATER"), false, false),
			0, null, "LINGERING_POTION"),
	LINGERING_POTION_NIGHT_VISION(new EPotion(PotionBase.LINGERING, PotionType.NIGHT_VISION, false, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_NIGHT_VISION_EXTENDED(new EPotion(PotionBase.LINGERING, PotionType.NIGHT_VISION, true, false), 0,
			null, "LINGERING_POTION"),
	LINGERING_POTION_POISON_1(new EPotion(PotionBase.LINGERING, PotionType.POISON, false, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_POISON_1_EXTENDED(new EPotion(PotionBase.LINGERING, PotionType.POISON, true, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_POISON_2(new EPotion(PotionBase.LINGERING, PotionType.POISON, false, true), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_REGENERATION_1(new EPotion(PotionBase.LINGERING, PotionType.REGEN, false, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_REGENERATION_1_EXTENDED(new EPotion(PotionBase.LINGERING, PotionType.REGEN, true, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_REGENERATION_2(new EPotion(PotionBase.LINGERING, PotionType.REGEN, false, true), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_SLOW_FALLING(new EPotion(PotionBase.LINGERING,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					...
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("SLOW_FALLING") : PotionType.WATER,
			false, false), 0, null, "LINGERING_POTION"),
	LINGERING_POTION_SLOW_FALLING_EXTENDED(new EPotion(PotionBase.LINGERING,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("SLOW_FALLING") : PotionType.WATER,
			true, false), 0, null, "LINGERING_POTION"),
	LINGERING_POTION_SLOWNESS_1(new EPotion(PotionBase.LINGERING, PotionType.SLOWNESS, false, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_SLOWNESS_1_EXTENDED(new EPotion(PotionBase.LINGERING, PotionType.SLOWNESS, true, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_SLOWNESS_2(new EPotion(PotionBase.LINGERING, PotionType.SLOWNESS, false, true), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_STRENGTH_1(new EPotion(PotionBase.LINGERING, PotionType.STRENGTH, false, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_STRENGTH_1_EXTENDED(new EPotion(PotionBase.LINGERING, PotionType.STRENGTH, true, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_STRENGTH_2(new EPotion(PotionBase.LINGERING, PotionType.STRENGTH, false, true), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_SWIFTNESS_1(new EPotion(PotionBase.LINGERING, PotionType.SPEED, false, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_SWIFTNESS_1_EXTENDED(new EPotion(PotionBase.LINGERING, PotionType.SPEED, true, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_SWIFTNESS_2(new EPotion(PotionBase.LINGERING, PotionType.SPEED, false, true), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_THICK(
			new EPotion(PotionBase.LINGERING,
					PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "THICK" : "WATER"), false, false),
			0, null, "LINGERING_POTION"),
	LINGERING_POTION_TURTLE_MASTER_1(new EPotion(PotionBase.LINGERING,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER,
			false, false), 0, null, "LINGERING_POTION"),
	LINGERING_POTION_TURTLE_MASTER_1_EXTENDED(new EPotion(PotionBase.LINGERING,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER,
			true, false), 0, null, "LINGERING_POTION"),
	LINGERING_POTION_TURTLE_MASTER_2(new EPotion(PotionBase.LINGERING,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER,
			false, true), 0, null, "LINGERING_POTION"),
	LINGERING_POTION_WATER(new EPotion(PotionBase.LINGERING, PotionType.WATER, false, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_WATER_BREATHING(new EPotion(PotionBase.LINGERING, PotionType.WATER_BREATHING, false, false), 0,
			null, "LINGERING_POTION"),
	LINGERING_POTION_WATER_BREATHING_EXTENDED(
			new EPotion(PotionBase.LINGERING, PotionType.WATER_BREATHING, true, false), 0, null, "LINGERING_POTION"),
	LINGERING_POTION_WEAKNESS(new EPotion(PotionBase.LINGERING, PotionType.WEAKNESS, false, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_WEAKNESS_EXTENDED(new EPotion(PotionBase.LINGERING, PotionType.WEAKNESS, true, false), 0, null,
			"LINGERING_POTION"),
	...
	NETHER_BRICK_STAIRS("NETHER_BRICK_STAIRS"), NETHER_BRICKS("NETHER_BRICK", null, null, null, null, "NETHER_BRICKS"),
	...
	NETHER_WART_BLOCK("NETHER_WARTS", null, null, null, null, "NETHER_WART_BLOCK"), NETHERRACK("NETHERRACK"),
	NOTE_BLOCK("NOTE_BLOCK"), OAK_BOAT("BOAT", null, null, null, null, "OAK_BOAT"),
	...
	POTION_AWKWARD("POTION", !Bukkit.getVersion().contains("1.8") ? 0 : 16,
			new EPotion(PotionBase.NORMAL,
					PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "AWKWARD" : "WATER"), false, false)),
	POTION_FIRE_RESISTANCE("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.FIRE_RESISTANCE, false, false)),
	POTION_FIRE_RESISTANCE_EXTENDED("POTION", 0,
			new EPotion(PotionBase.NORMAL, PotionType.FIRE_RESISTANCE, true, false)),
	POTION_HARMING_1("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.INSTANT_DAMAGE, false, false)),
	POTION_HARMING_2("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.INSTANT_DAMAGE, false, true)),
	POTION_HEALING_1("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.INSTANT_HEAL, false, false)),
	POTION_HEALING_2("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.INSTANT_HEAL, false, true)),
	POTION_INVISIBILITY("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.INVISIBILITY, false, false)),
	POTION_INVISIBILITY_EXTENDED("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.INVISIBILITY, true, false)),
	POTION_LEAPING_1("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.JUMP, false, false)),
	POTION_LEAPING_1_EXTENDED("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.JUMP, true, false)),
	POTION_LEAPING_2("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.JUMP, false, true)),
	POTION_LUCK("POTION", 0, new EPotion(PotionBase.NORMAL,
			!Bukkit.getVersion().contains("1.8") ? PotionType.valueOf("LUCK") : PotionType.WATER, false, false)),
	POTION_MUNDANE("POTION", 0,
			new EPotion(PotionBase.NORMAL,
					PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "MUNDANE" : "WATER"), false, false)),
	POTION_NIGHT_VISION("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.NIGHT_VISION, false, false)),
	POTION_NIGHT_VISION_EXTENDED("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.NIGHT_VISION, true, false)),
	POTION_POISON_1("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.POISON, false, false)),
	POTION_POISON_1_EXTENDED("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.POISON, true, false)),
	POTION_POISON_2("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.POISON, false, true)),
	POTION_REGENERATION_1("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.REGEN, false, false)),
	POTION_REGENERATION_1_EXTENDED("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.REGEN, true, false)),
	POTION_REGENERATION_2("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.REGEN, false, true)),
	POTION_SLOW_FALLING("POTION", 0, new EPotion(PotionBase.NORMAL,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("SLOW_FALLING") : PotionType.WATER,
			false, false)),
	POTION_SLOW_FALLING_EXTENDED("POTION", 0, new EPotion(PotionBase.NORMAL,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("SLOW_FALLING") : PotionType.WATER,
			true, false)),
	POTION_SLOWNESS_1("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.SLOWNESS, false, false)),
	POTION_SLOWNESS_1_EXTENDED("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.SLOWNESS, true, false)),
	POTION_SLOWNESS_2("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.SLOWNESS, false, true)),
	POTION_STRENGTH_1("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.STRENGTH, false, false)),
	POTION_STRENGTH_1_EXTENDED("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.STRENGTH, true, false)),
	POTION_STRENGTH_2("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.STRENGTH, false, true)),
	POTION_SWIFTNESS_1("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.SPEED, false, false)),
	POTION_SWIFTNESS_1_EXTENDED("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.SPEED, true, false)),
	POTION_SWIFTNESS_2("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.SPEED, false, true)),
	POTION_THICK("POTION", 0,
			new EPotion(PotionBase.NORMAL, PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "THICK" : "WATER"),
					false, false)),
	POTION_TURTLE_MASTER_1("POTION", 0, new EPotion(PotionBase.NORMAL,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER,
			false, false)),
	POTION_TURTLE_MASTER_1_EXTENDED("POTION", 0, new EPotion(PotionBase.NORMAL,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER,
			true, false)),
	POTION_TURTLE_MASTER_2("POTION", 0, new EPotion(PotionBase.NORMAL,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER,
			false, true)),
	POTION_WATER("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.WATER, false, false)),
	POTION_WATER_BREATHING("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.WATER_BREATHING, false, false)),
	POTION_WATER_BREATHING_EXTENDED("POTION", 0,
			new EPotion(PotionBase.NORMAL, PotionType.WATER_BREATHING, true, false)),
	POTION_WEAKNESS("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.WEAKNESS, false, false)),
	POTION_WEAKNESS_EXTENDED("POTION", 0, new EPotion(PotionBase.NORMAL, PotionType.WEAKNESS, true, false)),
	...
	POTTED_WHITE_TULIP(null, null, null, null, null, "POTTED_WHITE_TULIP"), POWERED_RAIL("POWERED_RAIL"),
	...
	RAIL("RAILS", null, null, null, null, "RAIL"), RED_BANNER(1, "BANNER", null, null, null, null, "RED_BANNER"),
	...
	RED_SANDSTONE_STAIRS("RED_SANDSTONE_STAIRS"), RED_SHULKER_BOX(null, null, null, "RED_SHULKER_BOX"),
	...
	ROSE_RED(1, "INK_SACK", null, null, null, null, "ROSE_RED"), ROTTEN_FLESH("ROTTEN_FLESH"), SADDLE("SADDLE"),
	...
	SCUTE(null, null, null, null, null, "SCUTE"), SEA_LANTERN("SEA_LANTERN"),
	SEA_PICKLE(null, null, null, null, null, "SEA_PICKLE"), SEAGRASS(null, null, null, null, null, "SEAGRASS"),
	SHEARS("SHEARS"), SHEEP_SPAWN_EGG(91, "MONSTER_EGG", null, null, null, null, "SHEEP_SPAWN_EGG"),
	SHIELD(null, "SHIELD"), SHULKER_BOX(null, null, null, "WHITE_SHULKER_BOX"),
	SHULKER_SHELL(null, null, null, "SHULKER_SHELL"),
	SHULKER_SPAWN_EGG(69, null, null, null, "MONSTER_EGG", null, "SHULKER_SPAWN_EGG"), SIGN("SIGN"),
	...
	SKELETON_WALL_SKULL("SKULL", null, null, null, null, "SKELETON_WALL_SKULL"), SLIME_BALL("SLIME_BALL"),
	...
	SMOOTH_STONE(8, "DOUBLE_STEP", null, null, null, null, "SMOOTH_STONE"), SNOW("SNOW"), SNOW_BLOCK("SNOW_BLOCK"),
	...
	SPLASH_POTION_AWKWARD(
			new EPotion(PotionBase.SPLASH,
					PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "AWKWARD" : "WATER"), false, false),
			0, null, "SPLASH_POTION"),
	SPLASH_POTION_FIRE_RESISTANCE(new EPotion(PotionBase.SPLASH, PotionType.FIRE_RESISTANCE, false, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_FIRE_RESISTANCE_EXTENDED(new EPotion(PotionBase.SPLASH, PotionType.FIRE_RESISTANCE, true, false), 0,
			null, "SPLASH_POTION"),
	SPLASH_POTION_HARMING_1(new EPotion(PotionBase.SPLASH, PotionType.INSTANT_DAMAGE, false, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_HARMING_2(new EPotion(PotionBase.SPLASH, PotionType.INSTANT_DAMAGE, false, true), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_HEALING_1(new EPotion(PotionBase.SPLASH, PotionType.INSTANT_HEAL, false, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_HEALING_2(new EPotion(PotionBase.SPLASH, PotionType.INSTANT_HEAL, false, true), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_INVISIBILITY(new EPotion(PotionBase.SPLASH, PotionType.INVISIBILITY, false, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_INVISIBILITY_EXTENDED(new EPotion(PotionBase.SPLASH, PotionType.INVISIBILITY, true, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_LEAPING_1(new EPotion(PotionBase.SPLASH, PotionType.JUMP, false, false), 0, null, "SPLASH_POTION"),
	SPLASH_POTION_LEAPING_1_EXTENDED(new EPotion(PotionBase.SPLASH, PotionType.JUMP, true, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_LEAPING_2(new EPotion(PotionBase.SPLASH, PotionType.JUMP, false, true), 0, null, "SPLASH_POTION"),
	SPLASH_POTION_LUCK(
			new EPotion(PotionBase.SPLASH,
					!Bukkit.getVersion().contains("1.8") ? PotionType.valueOf("LUCK") : PotionType.WATER, false, false),
			0, null, "SPLASH_POTION"),
	SPLASH_POTION_MUNDANE(
			new EPotion(PotionBase.SPLASH,
					PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "MUNDANE" : "WATER"), false, false),
			0, null, "SPLASH_POTION"),
	SPLASH_POTION_NIGHT_VISION(new EPotion(PotionBase.SPLASH, PotionType.NIGHT_VISION, false, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_NIGHT_VISION_EXTENDED(new EPotion(PotionBase.SPLASH, PotionType.NIGHT_VISION, true, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_POISON_1(new EPotion(PotionBase.SPLASH, PotionType.POISON, false, false), 0, null, "SPLASH_POTION"),
	SPLASH_POTION_POISON_1_EXTENDED(new EPotion(PotionBase.SPLASH, PotionType.POISON, true, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_POISON_2(new EPotion(PotionBase.SPLASH, PotionType.POISON, false, true), 0, null, "SPLASH_POTION"),
	SPLASH_POTION_REGENERATION_1(new EPotion(PotionBase.SPLASH, PotionType.REGEN, false, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_REGENERATION_1_EXTENDED(new EPotion(PotionBase.SPLASH, PotionType.REGEN, true, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_REGENERATION_2(new EPotion(PotionBase.SPLASH, PotionType.REGEN, false, true), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_SLOW_FALLING(new EPotion(PotionBase.SPLASH,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("SLOW_FALLING") : PotionType.WATER,
			false, false), 0, null, "SPLASH_POTION"),
	SPLASH_POTION_SLOW_FALLING_EXTENDED(new EPotion(PotionBase.SPLASH,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("SLOW_FALLING") : PotionType.WATER,
			true, false), 0, null, "SPLASH_POTION"),
	SPLASH_POTION_SLOWNESS_1(new EPotion(PotionBase.SPLASH, PotionType.SLOWNESS, false, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_SLOWNESS_1_EXTENDED(new EPotion(PotionBase.SPLASH, PotionType.SLOWNESS, true, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_SLOWNESS_2(new EPotion(PotionBase.SPLASH, PotionType.SLOWNESS, false, true), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_STRENGTH_1(new EPotion(PotionBase.SPLASH, PotionType.STRENGTH, false, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_STRENGTH_1_EXTENDED(new EPotion(PotionBase.SPLASH, PotionType.STRENGTH, true, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_STRENGTH_2(new EPotion(PotionBase.SPLASH, PotionType.STRENGTH, false, true), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_SWIFTNESS_1(new EPotion(PotionBase.SPLASH, PotionType.SPEED, false, false), 0, null, "SPLASH_POTION"),
	SPLASH_POTION_SWIFTNESS_1_EXTENDED(new EPotion(PotionBase.SPLASH, PotionType.SPEED, true, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_SWIFTNESS_2(new EPotion(PotionBase.SPLASH, PotionType.SPEED, false, true), 0, null, "SPLASH_POTION"),
	SPLASH_POTION_THICK(new EPotion(PotionBase.SPLASH,
			PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "THICK" : "WATER"), false, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_TURTLE_MASTER_1(new EPotion(PotionBase.SPLASH,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER,
			false, false), 0, null, "SPLASH_POTION"),
	SPLASH_POTION_TURTLE_MASTER_1_EXTENDED(new EPotion(PotionBase.SPLASH,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER,
			true, false), 0, null, "SPLASH_POTION"),
	SPLASH_POTION_TURTLE_MASTER_2(new EPotion(PotionBase.SPLASH,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER,
			false, true), 0, null, "SPLASH_POTION"),
	SPLASH_POTION_WATER(new EPotion(PotionBase.SPLASH, PotionType.WATER, false, false), 0, null, "SPLASH_POTION"),
	SPLASH_POTION_WATER_BREATHING(new EPotion(PotionBase.SPLASH, PotionType.WATER_BREATHING, false, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_WATER_BREATHING_EXTENDED(new EPotion(PotionBase.SPLASH, PotionType.WATER_BREATHING, true, false), 0,
			null, "SPLASH_POTION"),
	SPLASH_POTION_WEAKNESS(new EPotion(PotionBase.SPLASH, PotionType.WEAKNESS, false, false), 0, null, "SPLASH_POTION"),
	SPLASH_POTION_WEAKNESS_EXTENDED(new EPotion(PotionBase.SPLASH, PotionType.WEAKNESS, true, false), 0, null,
			"SPLASH_POTION"),
	...
	STRUCTURE_BLOCK(null, "STRUCTURE_BLOCK"), SUGAR("SUGAR"), SUGAR_CANE_ITEM("SUGAR_CANE"),
	...
	TIPPED_ARROW_FIRE_RESISTANCE(new EPotion(PotionBase.ARROW, PotionType.FIRE_RESISTANCE, false, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_FIRE_RESISTANCE_EXTENDED(new EPotion(PotionBase.ARROW, PotionType.FIRE_RESISTANCE, true, false), 0,
			"ARROW", "TIPPED_ARROW"),
	TIPPED_ARROW_HARMING_1(new EPotion(PotionBase.ARROW, PotionType.INSTANT_DAMAGE, false, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_HARMING_2(new EPotion(PotionBase.ARROW, PotionType.INSTANT_DAMAGE, false, true), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_HEALING_1(new EPotion(PotionBase.ARROW, PotionType.INSTANT_HEAL, false, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_HEALING_2(new EPotion(PotionBase.ARROW, PotionType.INSTANT_HEAL, false, true), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_INVISIBILITY(new EPotion(PotionBase.ARROW, PotionType.INVISIBILITY, false, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_INVISIBILITY_EXTENDED(new EPotion(PotionBase.ARROW, PotionType.INVISIBILITY, true, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_LEAPING_1(new EPotion(PotionBase.ARROW, PotionType.JUMP, false, false), 0, "ARROW", "TIPPED_ARROW"),
	TIPPED_ARROW_LEAPING_1_EXTENDED(new EPotion(PotionBase.ARROW, PotionType.JUMP, true, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_LEAPING_2(new EPotion(PotionBase.ARROW, PotionType.JUMP, false, true), 0, "ARROW", "TIPPED_ARROW"),
	TIPPED_ARROW_LUCK(new EPotion(PotionBase.ARROW,
			PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "LUCK" : "JUMP"), false, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_NIGHT_VISION(new EPotion(PotionBase.ARROW, PotionType.NIGHT_VISION, false, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_NIGHT_VISION_EXTENDED(new EPotion(PotionBase.ARROW, PotionType.NIGHT_VISION, true, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_POISON_1(new EPotion(PotionBase.ARROW, PotionType.POISON, false, false), 0, "ARROW", "TIPPED_ARROW"),
	TIPPED_ARROW_POISON_1_EXTENDED(new EPotion(PotionBase.ARROW, PotionType.POISON, true, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_POISON_2(new EPotion(PotionBase.ARROW, PotionType.POISON, false, true), 0, "ARROW", "TIPPED_ARROW"),
	TIPPED_ARROW_REGENERATION_1(new EPotion(PotionBase.ARROW, PotionType.REGEN, false, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_REGENERATION_1_EXTENDED(new EPotion(PotionBase.ARROW, PotionType.REGEN, true, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_REGENERATION_2(new EPotion(PotionBase.ARROW, PotionType.REGEN, false, true), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_SLOW_FALLING(
			new EPotion(PotionBase.ARROW,
					PotionType.valueOf(!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
							&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
							&& !Bukkit.getVersion().contains("1.12") ? "SLOW_FALLING" : "SLOWNESS"),
					false, false),
			0, "ARROW", "TIPPED_ARROW"),
	TIPPED_ARROW_SLOW_FALLING_EXTENDED(
			new EPotion(PotionBase.ARROW,
					...
					true, false),
			0, "ARROW", "TIPPED_ARROW"),
	TIPPED_ARROW_SLOWNESS_1(new EPotion(PotionBase.ARROW, PotionType.SLOWNESS, false, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_SLOWNESS_1_EXTENDED(new EPotion(PotionBase.ARROW, PotionType.SLOWNESS, true, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_SLOWNESS_2(new EPotion(PotionBase.ARROW, PotionType.SLOWNESS, false, true), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_STRENGTH_1(new EPotion(PotionBase.ARROW, PotionType.STRENGTH, false, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_STRENGTH_1_EXTENDED(new EPotion(PotionBase.ARROW, PotionType.STRENGTH, true, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_STRENGTH_2(new EPotion(PotionBase.ARROW, PotionType.STRENGTH, false, true), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_SWIFTNESS_1(new EPotion(PotionBase.ARROW, PotionType.SPEED, false, false), 0, "ARROW", "TIPPED_ARROW"),
	TIPPED_ARROW_SWIFTNESS_1_EXTENDED(new EPotion(PotionBase.ARROW, PotionType.SPEED, true, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_SWIFTNESS_2(new EPotion(PotionBase.ARROW, PotionType.SPEED, false, true), 0, "ARROW", "TIPPED_ARROW"),
	TIPPED_ARROW_TURTLE_MASTER_1(
			new EPotion(PotionBase.ARROW,
					PotionType.valueOf(!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
							&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
							&& !Bukkit.getVersion().contains("1.12") ? "TURTLE_MASTER" : "SLOWNESS"),
					false, false),
			0, "ARROW", "TIPPED_ARROW"),
	...
	TIPPED_ARROW_TURTLE_MASTER_2(
			new EPotion(PotionBase.ARROW,
					...
					false, true),
			0, "ARROW", "TIPPED_ARROW"),
	TIPPED_ARROW_WATER_BREATHING(new EPotion(PotionBase.ARROW, PotionType.WATER_BREATHING, false, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_WATER_BREATHING_EXTENDED(new EPotion(PotionBase.ARROW, PotionType.WATER_BREATHING, true, false), 0,
			"ARROW", "TIPPED_ARROW"),
	TIPPED_ARROW_WEAKNESS(new EPotion(PotionBase.ARROW, PotionType.WEAKNESS, false, false), 0, "ARROW", "TIPPED_ARROW"),
	TIPPED_ARROW_WEAKNESS_EXTENDED(new EPotion(PotionBase.ARROW, PotionType.WEAKNESS, true, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TNT("TNT"), TNT_MINECART("EXPLOSIVE_MINECART", null, null, null, null, "TNT_MINECART"), TORCH("TORCH"),
	TOTEM_OF_UNDYING(null, null, null, "TOTEM", null, "TOTEM_OF_UNDYING"), TRAPPED_CHEST("TRAPPED_CHEST"),
	TRIDENT(null, null, null, null, null, "TRIDENT"), TRIPWIRE("TRIPWIRE"), TRIPWIRE_HOOK("TRIPWIRE_HOOK"),
	...
	VOID_AIR("AIR", null, null, null, null, "VOID_AIR"), WALL_SIGN("WALL_SIGN"),
	WALL_TORCH(null, null, null, null, null, "WALL_TORCH"), WATER("WATER"), WATER_BUCKET("WATER_BUCKET"),
	WET_SPONGE(1, "SPONGE", null, null, null, null, "WET_SPONGE"), WHEAT("WHEAT"),
	...
	private static final HashMap<String, OldUMaterial> inUMemory = new HashMap<>();
	...
	OldUMaterial(String... names) {
		this(0, names);
	}

	OldUMaterial(String name, int data) {
		names[0] = name;
		this.data = data;
		final Material m = Material.matchMaterial(name);
		material = m;
		is = version.contains("1.8") || version.contains("1.9") || version.contains("1.10") || version.contains("1.11")
				|| version.contains("1.12") ? new ItemStack(m, 1, (byte) data) : new ItemStack(m);
	}

	OldUMaterial(String name, int spoofedData, Color color) {
		names[0] = name;
	...
	OldUMaterial(String name, int data, EPotion pd) {
		doPotion(setItemStack(name, data), pd);
	}

	OldUMaterial(EPotion pd, int data, String... names) {
		doPotion(setItemStack(data, names), pd);
	}

	OldUMaterial(String name, Enchantment enchant, int level) {
		doEnchantmentBook(setItemStack(0, name), enchant, level);
	}

	OldUMaterial(int data, String... names) {
		this.names = names;
		this.data = data;
	...
	OldUMaterial(int data, int returnData, String... names) {
		this.names = names;
		this.data = data;
		final Material m = getMaterialName();
		material = m;
		is = version.contains("1.8") || version.contains("1.9") || version.contains("1.10") || version.contains("1.11")
				|| version.contains("1.12") ? new ItemStack(m, 1, (byte) returnData) : new ItemStack(m);
	}

	private void doPotion(ItemStack m, EPotion up) {
	...
	private ItemStack setItemStack(String name, int data) {
		...
		final Material m = getMaterialName();
		material = m;
		return version.contains("1.8") || version.contains("1.9") || version.contains("1.10")
				|| version.contains("1.11") || version.contains("1.12") ? new ItemStack(m, 1, (byte) data)
						: new ItemStack(m);
	}
	...
	@Deprecated
	public static OldUMaterial match(String name, byte data) {
		name = name.toUpperCase();
		if (inUMemory.keySet().contains(name + data))
			return inUMemory.get(name + data);
		for (OldUMaterial u : OldUMaterial.values()) {
	...
	public static OldUMaterial fromEgg(ItemStack egg) {
		if (egg != null) {
			...
			if (v.contains("1.8")) {
				...
				final String id = egg.hasItemMeta()
						...
						: "PIG";
				return fromString(id + "_SPAWN_EGG");
			} else {
				return fromString(egg.getType().name());
			}
		}
		return null;
	}

	public static OldUMaterial fromEnchantedBook(ItemStack book) {
																																																										...
																																																										"ARROW_INFINITE")
																																																												...
																																																												: n.equals(
																																																														"LUCK") ? "LUCK_OF_THE_SEA"
																																																																: n;
				return fromString("ENCHANTED_BOOK_" + (e.getMaxLevel() != 1 ? name + "_" + l : name));
			}
		}
		return null;
	}

	public static OldUMaterial fromPotion(ItemStack potion, PotionBase base) {
		if (potion != null && potion.getItemMeta() instanceof PotionMeta) {
			...
			if (ce.size() == 0) {
				...
				return T != null ? fromString(g) : null;
			}
		}
		return null;
	}
	...
	@Deprecated
	public static OldUMaterial fromItem(ItemStack item) {
		if (item != null) {
			final OldUMaterial u = match(item.getType().name(), item.getData().getData());
			final String un = u.name();
			return un.contains("SPAWN_EGG") ? fromEgg(item)
					: un.contains("ENCHANTED_BOOK") ? fromEnchantedBook(item)
							: un.contains("POTION")
									? fromPotion(item, PotionBase.valueOf(un.contains("SPLASH") ? "SPLASH"
	...
	public static OldUMaterial fromString(String name) {
...
class EPotion {
	...
	@SuppressWarnings("deprecation")
	public EPotion(OldUMaterial.PotionBase base, PotionType type, boolean extended, boolean upgraded) {
		final String bn = base.name();
		if (v.contains("1.8")) {
			potion = type.name().equals("WATER") ? new Potion(type).toItemStack(1)
					: new Potion(type, upgraded ? 2 : 1, bn.equals("SPLASH")).toItemStack(1);
			potiondata = potion.getItemMeta();
		} else {
			final ItemStack is = new ItemStack(Material.matchMaterial(bn.equals("NORMAL") ? "POTION"
					: bn.equals("ARROW")
							? v.contains("1.8") || v.contains("1.9") || v.contains("1.11") ? "ARROW" : "TIPPED_ARROW"
							: bn + "_POTION"));
			...
			if (a) {
				...
				pd = new org.bukkit.potion.PotionData(type, type.isExtendable() && extended,
						type.isUpgradeable() && upgraded);
			}
			potiondata = pd;
			if (a) {
