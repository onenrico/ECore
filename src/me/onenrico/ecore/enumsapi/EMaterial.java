...
public enum EMaterial {
    ...
    */
    ...
    public Material parseMaterial() { return material; }
    public ItemStack parseItem() { return is != null ? is.clone() : null; }
    ...
    public static EMaterial matchSpawnEgg(ItemStack egg) {
        if(egg != null) {
    ...
    public static EMaterial matchEnchantedBook(ItemStack book) {
    ...
    public static EMaterial matchPotion(ItemStack potion, PotionBase base) {
    ...
    public static EMaterial getItem(Block block) {
...
class UPotion {
    ...
    public UPotion(EMaterial.PotionBase base, String type, boolean extended, boolean upgraded) {
