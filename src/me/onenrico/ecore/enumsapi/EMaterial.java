...
public enum EMaterial {
	...
	LINGERING_POTION_AWKWARD(
			new UPotion(PotionBase.LINGERING,
					PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "AWKWARD" : "WATER"), false, false),
			0, null, "LINGERING_POTION"),
	LINGERING_POTION_FIRE_RESISTANCE(new UPotion(PotionBase.LINGERING, PotionType.FIRE_RESISTANCE, false, false), 0,
			null, "LINGERING_POTION"),
	LINGERING_POTION_FIRE_RESISTANCE_EXTENDED(
			new UPotion(PotionBase.LINGERING, PotionType.FIRE_RESISTANCE, true, false), 0, null, "LINGERING_POTION"),
	LINGERING_POTION_HARMING_1(new UPotion(PotionBase.LINGERING, PotionType.INSTANT_DAMAGE, false, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_HARMING_2(new UPotion(PotionBase.LINGERING, PotionType.INSTANT_DAMAGE, false, true), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_HEALING_1(new UPotion(PotionBase.LINGERING, PotionType.INSTANT_HEAL, false, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_HEALING_2(new UPotion(PotionBase.LINGERING, PotionType.INSTANT_HEAL, false, true), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_INVISIBILITY(new UPotion(PotionBase.LINGERING, PotionType.INVISIBILITY, false, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_INVISIBILITY_EXTENDED(new UPotion(PotionBase.LINGERING, PotionType.INVISIBILITY, true, false), 0,
			null, "LINGERING_POTION"),
	LINGERING_POTION_LEAPING_1(new UPotion(PotionBase.LINGERING, PotionType.JUMP, false, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_LEAPING_1_EXTENDED(new UPotion(PotionBase.LINGERING, PotionType.JUMP, true, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_LEAPING_2(new UPotion(PotionBase.LINGERING, PotionType.JUMP, false, true), 0, null,
			"LINGERING_POTION"),
	...
	LINGERING_POTION_MUNDANE(
			...
			0, null, "LINGERING_POTION"),
	LINGERING_POTION_NIGHT_VISION(new UPotion(PotionBase.LINGERING, PotionType.NIGHT_VISION, false, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_NIGHT_VISION_EXTENDED(new UPotion(PotionBase.LINGERING, PotionType.NIGHT_VISION, true, false), 0,
			null, "LINGERING_POTION"),
	LINGERING_POTION_POISON_1(new UPotion(PotionBase.LINGERING, PotionType.POISON, false, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_POISON_1_EXTENDED(new UPotion(PotionBase.LINGERING, PotionType.POISON, true, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_POISON_2(new UPotion(PotionBase.LINGERING, PotionType.POISON, false, true), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_REGENERATION_1(new UPotion(PotionBase.LINGERING, PotionType.REGEN, false, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_REGENERATION_1_EXTENDED(new UPotion(PotionBase.LINGERING, PotionType.REGEN, true, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_REGENERATION_2(new UPotion(PotionBase.LINGERING, PotionType.REGEN, false, true), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_SLOW_FALLING(new UPotion(PotionBase.LINGERING,
	...
	LINGERING_POTION_SLOW_FALLING_EXTENDED(new UPotion(PotionBase.LINGERING,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("SLOW_FALLING") : PotionType.WATER,
			true, false), 0, null, "LINGERING_POTION"),
	LINGERING_POTION_SLOWNESS_1(new UPotion(PotionBase.LINGERING, PotionType.SLOWNESS, false, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_SLOWNESS_1_EXTENDED(new UPotion(PotionBase.LINGERING, PotionType.SLOWNESS, true, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_SLOWNESS_2(new UPotion(PotionBase.LINGERING, PotionType.SLOWNESS, false, true), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_STRENGTH_1(new UPotion(PotionBase.LINGERING, PotionType.STRENGTH, false, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_STRENGTH_1_EXTENDED(new UPotion(PotionBase.LINGERING, PotionType.STRENGTH, true, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_STRENGTH_2(new UPotion(PotionBase.LINGERING, PotionType.STRENGTH, false, true), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_SWIFTNESS_1(new UPotion(PotionBase.LINGERING, PotionType.SPEED, false, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_SWIFTNESS_1_EXTENDED(new UPotion(PotionBase.LINGERING, PotionType.SPEED, true, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_SWIFTNESS_2(new UPotion(PotionBase.LINGERING, PotionType.SPEED, false, true), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_THICK(
			new UPotion(PotionBase.LINGERING,
					PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "THICK" : "WATER"), false, false),
			0, null, "LINGERING_POTION"),
	LINGERING_POTION_TURTLE_MASTER_1(new UPotion(PotionBase.LINGERING,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER,
			false, false), 0, null, "LINGERING_POTION"),
	LINGERING_POTION_TURTLE_MASTER_1_EXTENDED(new UPotion(PotionBase.LINGERING,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER,
			true, false), 0, null, "LINGERING_POTION"),
	LINGERING_POTION_TURTLE_MASTER_2(new UPotion(PotionBase.LINGERING,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER,
			false, true), 0, null, "LINGERING_POTION"),
	LINGERING_POTION_WATER(new UPotion(PotionBase.LINGERING, PotionType.WATER, false, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_WATER_BREATHING(new UPotion(PotionBase.LINGERING, PotionType.WATER_BREATHING, false, false), 0,
			null, "LINGERING_POTION"),
	LINGERING_POTION_WATER_BREATHING_EXTENDED(
			new UPotion(PotionBase.LINGERING, PotionType.WATER_BREATHING, true, false), 0, null, "LINGERING_POTION"),
	LINGERING_POTION_WEAKNESS(new UPotion(PotionBase.LINGERING, PotionType.WEAKNESS, false, false), 0, null,
			"LINGERING_POTION"),
	LINGERING_POTION_WEAKNESS_EXTENDED(new UPotion(PotionBase.LINGERING, PotionType.WEAKNESS, true, false), 0, null,
			"LINGERING_POTION"),
	...
	POTION_FIRE_RESISTANCE_EXTENDED("POTION", 0,
			new UPotion(PotionBase.NORMAL, PotionType.FIRE_RESISTANCE, true, false)),
	...
	POTION_LUCK("POTION", 0, new UPotion(PotionBase.NORMAL,
			!Bukkit.getVersion().contains("1.8") ? PotionType.valueOf("LUCK") : PotionType.WATER, false, false)),
	...
	POTION_SLOW_FALLING("POTION", 0, new UPotion(PotionBase.NORMAL,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("SLOW_FALLING") : PotionType.WATER,
			false, false)),
	POTION_SLOW_FALLING_EXTENDED("POTION", 0, new UPotion(PotionBase.NORMAL,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("SLOW_FALLING") : PotionType.WATER,
			true, false)),
	...
	POTION_THICK("POTION", 0,
			new UPotion(PotionBase.NORMAL, PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "THICK" : "WATER"),
					false, false)),
	POTION_TURTLE_MASTER_1("POTION", 0, new UPotion(PotionBase.NORMAL,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER,
			false, false)),
	POTION_TURTLE_MASTER_1_EXTENDED("POTION", 0, new UPotion(PotionBase.NORMAL,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER,
			true, false)),
	POTION_TURTLE_MASTER_2("POTION", 0, new UPotion(PotionBase.NORMAL,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER,
			false, true)),
	...
	POTION_WATER_BREATHING_EXTENDED("POTION", 0,
			new UPotion(PotionBase.NORMAL, PotionType.WATER_BREATHING, true, false)),
	...
	SPLASH_POTION_AWKWARD(
			new UPotion(PotionBase.SPLASH,
					PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "AWKWARD" : "WATER"), false, false),
			0, null, "SPLASH_POTION"),
	SPLASH_POTION_FIRE_RESISTANCE(new UPotion(PotionBase.SPLASH, PotionType.FIRE_RESISTANCE, false, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_FIRE_RESISTANCE_EXTENDED(new UPotion(PotionBase.SPLASH, PotionType.FIRE_RESISTANCE, true, false), 0,
			null, "SPLASH_POTION"),
	SPLASH_POTION_HARMING_1(new UPotion(PotionBase.SPLASH, PotionType.INSTANT_DAMAGE, false, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_HARMING_2(new UPotion(PotionBase.SPLASH, PotionType.INSTANT_DAMAGE, false, true), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_HEALING_1(new UPotion(PotionBase.SPLASH, PotionType.INSTANT_HEAL, false, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_HEALING_2(new UPotion(PotionBase.SPLASH, PotionType.INSTANT_HEAL, false, true), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_INVISIBILITY(new UPotion(PotionBase.SPLASH, PotionType.INVISIBILITY, false, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_INVISIBILITY_EXTENDED(new UPotion(PotionBase.SPLASH, PotionType.INVISIBILITY, true, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_LEAPING_1(new UPotion(PotionBase.SPLASH, PotionType.JUMP, false, false), 0, null, "SPLASH_POTION"),
	SPLASH_POTION_LEAPING_1_EXTENDED(new UPotion(PotionBase.SPLASH, PotionType.JUMP, true, false), 0, null,
			"SPLASH_POTION"),
	...
	SPLASH_POTION_MUNDANE(
			new UPotion(PotionBase.SPLASH,
					PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "MUNDANE" : "WATER"), false, false),
			0, null, "SPLASH_POTION"),
	SPLASH_POTION_NIGHT_VISION(new UPotion(PotionBase.SPLASH, PotionType.NIGHT_VISION, false, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_NIGHT_VISION_EXTENDED(new UPotion(PotionBase.SPLASH, PotionType.NIGHT_VISION, true, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_POISON_1(new UPotion(PotionBase.SPLASH, PotionType.POISON, false, false), 0, null, "SPLASH_POTION"),
	SPLASH_POTION_POISON_1_EXTENDED(new UPotion(PotionBase.SPLASH, PotionType.POISON, true, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_POISON_2(new UPotion(PotionBase.SPLASH, PotionType.POISON, false, true), 0, null, "SPLASH_POTION"),
	SPLASH_POTION_REGENERATION_1(new UPotion(PotionBase.SPLASH, PotionType.REGEN, false, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_REGENERATION_1_EXTENDED(new UPotion(PotionBase.SPLASH, PotionType.REGEN, true, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_REGENERATION_2(new UPotion(PotionBase.SPLASH, PotionType.REGEN, false, true), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_SLOW_FALLING(new UPotion(PotionBase.SPLASH,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("SLOW_FALLING") : PotionType.WATER,
			false, false), 0, null, "SPLASH_POTION"),
	SPLASH_POTION_SLOW_FALLING_EXTENDED(new UPotion(PotionBase.SPLASH,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("SLOW_FALLING") : PotionType.WATER,
			true, false), 0, null, "SPLASH_POTION"),
	SPLASH_POTION_SLOWNESS_1(new UPotion(PotionBase.SPLASH, PotionType.SLOWNESS, false, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_SLOWNESS_1_EXTENDED(new UPotion(PotionBase.SPLASH, PotionType.SLOWNESS, true, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_SLOWNESS_2(new UPotion(PotionBase.SPLASH, PotionType.SLOWNESS, false, true), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_STRENGTH_1(new UPotion(PotionBase.SPLASH, PotionType.STRENGTH, false, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_STRENGTH_1_EXTENDED(new UPotion(PotionBase.SPLASH, PotionType.STRENGTH, true, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_STRENGTH_2(new UPotion(PotionBase.SPLASH, PotionType.STRENGTH, false, true), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_SWIFTNESS_1(new UPotion(PotionBase.SPLASH, PotionType.SPEED, false, false), 0, null, "SPLASH_POTION"),
	SPLASH_POTION_SWIFTNESS_1_EXTENDED(new UPotion(PotionBase.SPLASH, PotionType.SPEED, true, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_SWIFTNESS_2(new UPotion(PotionBase.SPLASH, PotionType.SPEED, false, true), 0, null, "SPLASH_POTION"),
	SPLASH_POTION_THICK(new UPotion(PotionBase.SPLASH,
			PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "THICK" : "WATER"), false, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_TURTLE_MASTER_1(new UPotion(PotionBase.SPLASH,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER,
			false, false), 0, null, "SPLASH_POTION"),
	SPLASH_POTION_TURTLE_MASTER_1_EXTENDED(new UPotion(PotionBase.SPLASH,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER,
			true, false), 0, null, "SPLASH_POTION"),
	SPLASH_POTION_TURTLE_MASTER_2(new UPotion(PotionBase.SPLASH,
			!Bukkit.getVersion().contains("1.8") && !Bukkit.getVersion().contains("1.9")
					&& !Bukkit.getVersion().contains("1.10") && !Bukkit.getVersion().contains("1.11")
					&& !Bukkit.getVersion().contains("1.12") ? PotionType.valueOf("TURTLE_MASTER") : PotionType.WATER,
	...
	SPLASH_POTION_WATER_BREATHING(new UPotion(PotionBase.SPLASH, PotionType.WATER_BREATHING, false, false), 0, null,
			"SPLASH_POTION"),
	SPLASH_POTION_WATER_BREATHING_EXTENDED(new UPotion(PotionBase.SPLASH, PotionType.WATER_BREATHING, true, false), 0,
			null, "SPLASH_POTION"),
	SPLASH_POTION_WEAKNESS(new UPotion(PotionBase.SPLASH, PotionType.WEAKNESS, false, false), 0, null, "SPLASH_POTION"),
	SPLASH_POTION_WEAKNESS_EXTENDED(new UPotion(PotionBase.SPLASH, PotionType.WEAKNESS, true, false), 0, null,
			"SPLASH_POTION"),
	...
	TIPPED_ARROW_FIRE_RESISTANCE(new UPotion(PotionBase.ARROW, PotionType.FIRE_RESISTANCE, false, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_FIRE_RESISTANCE_EXTENDED(new UPotion(PotionBase.ARROW, PotionType.FIRE_RESISTANCE, true, false), 0,
			"ARROW", "TIPPED_ARROW"),
	TIPPED_ARROW_HARMING_1(new UPotion(PotionBase.ARROW, PotionType.INSTANT_DAMAGE, false, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_HARMING_2(new UPotion(PotionBase.ARROW, PotionType.INSTANT_DAMAGE, false, true), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_HEALING_1(new UPotion(PotionBase.ARROW, PotionType.INSTANT_HEAL, false, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_HEALING_2(new UPotion(PotionBase.ARROW, PotionType.INSTANT_HEAL, false, true), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_INVISIBILITY(new UPotion(PotionBase.ARROW, PotionType.INVISIBILITY, false, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_INVISIBILITY_EXTENDED(new UPotion(PotionBase.ARROW, PotionType.INVISIBILITY, true, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_LEAPING_1(new UPotion(PotionBase.ARROW, PotionType.JUMP, false, false), 0, "ARROW", "TIPPED_ARROW"),
	TIPPED_ARROW_LEAPING_1_EXTENDED(new UPotion(PotionBase.ARROW, PotionType.JUMP, true, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_LEAPING_2(new UPotion(PotionBase.ARROW, PotionType.JUMP, false, true), 0, "ARROW", "TIPPED_ARROW"),
	TIPPED_ARROW_LUCK(new UPotion(PotionBase.ARROW,
			PotionType.valueOf(!Bukkit.getVersion().contains("1.8") ? "LUCK" : "JUMP"), false, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_NIGHT_VISION(new UPotion(PotionBase.ARROW, PotionType.NIGHT_VISION, false, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_NIGHT_VISION_EXTENDED(new UPotion(PotionBase.ARROW, PotionType.NIGHT_VISION, true, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_POISON_1(new UPotion(PotionBase.ARROW, PotionType.POISON, false, false), 0, "ARROW", "TIPPED_ARROW"),
	TIPPED_ARROW_POISON_1_EXTENDED(new UPotion(PotionBase.ARROW, PotionType.POISON, true, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_POISON_2(new UPotion(PotionBase.ARROW, PotionType.POISON, false, true), 0, "ARROW", "TIPPED_ARROW"),
	TIPPED_ARROW_REGENERATION_1(new UPotion(PotionBase.ARROW, PotionType.REGEN, false, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_REGENERATION_1_EXTENDED(new UPotion(PotionBase.ARROW, PotionType.REGEN, true, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_REGENERATION_2(new UPotion(PotionBase.ARROW, PotionType.REGEN, false, true), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_SLOW_FALLING(
			new UPotion(PotionBase.ARROW,
	...
	TIPPED_ARROW_SLOW_FALLING_EXTENDED(
			new UPotion(PotionBase.ARROW,
					...
					true, false),
			0, "ARROW", "TIPPED_ARROW"),
	TIPPED_ARROW_SLOWNESS_1(new UPotion(PotionBase.ARROW, PotionType.SLOWNESS, false, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_SLOWNESS_1_EXTENDED(new UPotion(PotionBase.ARROW, PotionType.SLOWNESS, true, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_SLOWNESS_2(new UPotion(PotionBase.ARROW, PotionType.SLOWNESS, false, true), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_STRENGTH_1(new UPotion(PotionBase.ARROW, PotionType.STRENGTH, false, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_STRENGTH_1_EXTENDED(new UPotion(PotionBase.ARROW, PotionType.STRENGTH, true, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_STRENGTH_2(new UPotion(PotionBase.ARROW, PotionType.STRENGTH, false, true), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_SWIFTNESS_1(new UPotion(PotionBase.ARROW, PotionType.SPEED, false, false), 0, "ARROW", "TIPPED_ARROW"),
	TIPPED_ARROW_SWIFTNESS_1_EXTENDED(new UPotion(PotionBase.ARROW, PotionType.SPEED, true, false), 0, "ARROW",
			"TIPPED_ARROW"),
	...
	TIPPED_ARROW_TURTLE_MASTER_2(
			new UPotion(PotionBase.ARROW,
					...
					false, true),
			0, "ARROW", "TIPPED_ARROW"),
	TIPPED_ARROW_WATER_BREATHING(new UPotion(PotionBase.ARROW, PotionType.WATER_BREATHING, false, false), 0, "ARROW",
			"TIPPED_ARROW"),
	TIPPED_ARROW_WATER_BREATHING_EXTENDED(new UPotion(PotionBase.ARROW, PotionType.WATER_BREATHING, true, false), 0,
			"ARROW", "TIPPED_ARROW"),
	TIPPED_ARROW_WEAKNESS(new UPotion(PotionBase.ARROW, PotionType.WEAKNESS, false, false), 0, "ARROW", "TIPPED_ARROW"),
	TIPPED_ARROW_WEAKNESS_EXTENDED(new UPotion(PotionBase.ARROW, PotionType.WEAKNESS, true, false), 0, "ARROW",
			"TIPPED_ARROW"),
	...
	private static final HashMap<String, EMaterial> inUMemory = new HashMap<>();
	...
	EMaterial(String... names) {
		this(0, names);
	}

	EMaterial(String name, int data) {
		names[0] = name;
		this.data = data;
	...
	EMaterial(String name, int spoofedData, Color color) {
		names[0] = name;
	...
	EMaterial(String name, int data, UPotion pd) {
		doPotion(setItemStack(name, data), pd);
	}

	EMaterial(UPotion pd, int data, String... names) {
		doPotion(setItemStack(data, names), pd);
	}

	EMaterial(String name, Enchantment enchant, int level) {
		doEnchantmentBook(setItemStack(0, name), enchant, level);
	}

	EMaterial(int data, String... names) {
		this.names = names;
		this.data = data;
	...
	EMaterial(int data, int returnData, String... names) {
		this.names = names;
		this.data = data;
		final Material m = getMaterialName();
		material = m;
	...
	@Deprecated
	public static EMaterial match(String name, byte data) {
		name = name.toUpperCase();
		if (inUMemory.keySet().contains(name + data))
			return inUMemory.get(name + data);
		for (EMaterial u : EMaterial.values()) {
	...
	public static EMaterial fromEgg(ItemStack egg) {
		if (egg != null) {
	...
	public static EMaterial fromEnchantedBook(ItemStack book) {
	...
	public static EMaterial fromPotion(ItemStack potion, PotionBase base) {
	...
	@Deprecated
	public static EMaterial fromItem(ItemStack item) {
		if (item != null) {
			final EMaterial u = match(item.getType().name(), item.getData().getData());
	...
	public static EMaterial fromString(String name) {
...
class UPotion {
	...
	@SuppressWarnings("deprecation")
	public UPotion(EMaterial.PotionBase base, PotionType type, boolean extended, boolean upgraded) {
