...
public enum EMaterial {
	...
	BRAIN_CORAL_BLOCK(0, "BRAIN_CORAL_BLOCK"),

	BRAIN_CORAL_FAN(0, "BRAIN_CORAL_FAN"),

	BREAD(0, "BREAD"),

	BREWING_STAND(0, "BREWING_STAND"),
	...
	BUBBLE_COLUMN(0, "BUBBLE_COLUMN"),

	BUBBLE_CORAL(0, "BUBBLE_CORAL"),

	BUBBLE_CORAL_BLOCK(0, "BUBBLE_CORAL_BLOCK"),

	BUBBLE_CORAL_FAN(0, "BUBBLE_CORAL_FAN"),
	...
	CUT_RED_SANDSTONE(0, "CUT_RED_SANDSTONE"),

	CUT_SANDSTONE(0, "CUT_SANDSTONE"),
	...
	DARK_PRISMARINE_SLAB(0, "DARK_PRISMARINE_SLAB"),

	DARK_PRISMARINE_STAIRS(0, "DARK_PRISMARINE_STAIRS"),

	DAYLIGHT_DETECTOR(0, "DAYLIGHT_DETECTOR"),

	DEAD_BRAIN_CORAL_BLOCK(0, "DEAD_BRAIN_CORAL_BLOCK"),

	DEAD_BUBBLE_CORAL_BLOCK(0, "DEAD_BUBBLE_CORAL_BLOCK"),

	DEAD_BUSH(0, "LONG_GRASS", "DEAD_BUSH"),

	DEAD_FIRE_CORAL_BLOCK(0, "DEAD_FIRE_CORAL_BLOCK"),

	DEAD_HORN_CORAL_BLOCK(0, "DEAD_HORN_CORAL_BLOCK"),

	DEAD_TUBE_CORAL_BLOCK(0, "DEAD_TUBE_CORAL_BLOCK"),
	...
	DRIED_KELP(0, "DRIED_KELP"),

	DRIED_KELP_BLOCK(0, "DRIED_KELP_BLOCK"),
	...
	FIRE_CORAL(0, "FIRE_CORAL"),

	FIRE_CORAL_BLOCK(0, "FIRE_CORAL_BLOCK"),

	FIRE_CORAL_FAN(0, "FIRE_CORAL_FAN"),
	...
	GRAY_TERRACOTTA(8, "STAINED_CLAY"),
	...
	HEART_OF_THE_SEA(0, "HEART_OF_THE_SEA"),
	...
	HORN_CORAL(0, "HORN_CORAL"),

	HORN_CORAL_BLOCK(0, "HORN_CORAL_BLOCK"),

	HORN_CORAL_FAN(0, "HORN_CORAL_FAN"),
	...
	LIGHT_BLUE_WALL_BANNER(0, "BANNER"),
	...
	NAUTILUS_SHELL(0, "NAUTILUS_SHELL"),
	...
	NETHER_WART_BLOCK(0, "NETHER_WART_BLOCK"),
	...
	PETRIFIED_OAK_SLAB(0, "PETRIFIED_OAK_SLAB"),

	PHANTOM_MEMBRANE(0, "PHANTOM_MEMBRANE"),
	...
	PRISMARINE_BRICK_SLAB(0, "PRISMARINE_BRICK_SLAB"),

	PRISMARINE_BRICK_STAIRS(0, "PRISMARINE_BRICK_STAIRS"),

	PRISMARINE_CRYSTALS(0, "PRISMARINE_CRYSTALS"),

	PRISMARINE_SHARD(0, "PRISMARINE_SHARD"),

	PRISMARINE_SLAB(0, "PRISMARINE_SLAB"),

	PRISMARINE_STAIRS(0, "PRISMARINE_STAIRS"),

	PUFFERFISH(3, "RAW_FISH"),

	PUFFERFISH_BUCKET(0, "PUFFERFISH_BUCKET"),
	...
	REDSTONE_LAMP(0, "REDSTONE_LAMP_OFF"),

	REDSTONE_ORE(0, "REDSTONE_ORE"),

	REDSTONE_TORCH(0, "REDSTONE_TORCH_ON"),
	...
	RED_MUSHROOM_BLOCK(0, "RED_MUSHROOM"),
	...
	RED_SANDSTONE_SLAB(0, "STONE_SLAB2"),
	...
	STRIPPED_ACACIA_LOG(0, "STRIPPED_ACACIA_LOG"),

	STRIPPED_ACACIA_WOOD(0, "STRIPPED_ACACIA_WOOD"),

	STRIPPED_BIRCH_LOG(0, "STRIPPED_BIRCH_LOG"),

	STRIPPED_BIRCH_WOOD(0, "STRIPPED_BIRCH_WOOD"),

	STRIPPED_DARK_OAK_LOG(0, "STRIPPED_DARK_OAK_LOG"),

	STRIPPED_DARK_OAK_WOOD(0, "STRIPPED_DARK_OAK_WOOD"),

	STRIPPED_JUNGLE_LOG(0, "STRIPPED_JUNGLE_LOG"),

	STRIPPED_JUNGLE_WOOD(0, "STRIPPED_JUNGLE_WOOD"),

	STRIPPED_OAK_LOG(0, "STRIPPED_OAK_LOG"),

	STRIPPED_OAK_WOOD(0, "STRIPPED_OAK_WOOD"),

	STRIPPED_SPRUCE_LOG(0, "STRIPPED_SPRUCE_LOG"),

	STRIPPED_SPRUCE_WOOD(0, "STRIPPED_SPRUCE_WOOD"),
	...
	TUBE_CORAL_BLOCK(0, "TUBE_CORAL_BLOCK"),

	TUBE_CORAL_FAN(0, "TUBE_CORAL_FAN"),

	TURTLE_EGG(0, "MONSTER_EGG"),

	TURTLE_HELMET(0, "TURTLE_HELMET"),
	...
	WHITE_TERRACOTTA(0, "STAINED_CLAY"),
	...
	public boolean fromsupernew = false;
	private static Boolean isnew = false;
	private static HashMap<String, EMaterial> cachedstring = new HashMap<>();
	private static HashMap<EMaterial, Boolean> cachedunique = new HashMap<>();
	private static HashMap<EMaterial, Material> cachedematerial = new HashMap<>();
	private static HashMap<Material, EMaterial> cachedmaterial = new HashMap<>();
	private static HashMap<EMaterial, ItemStack> cacheditemstack = new HashMap<>();

	private EMaterial(final int data, String... m) {
		this.data = data;
		this.m = m;
		if (this.m[0].equals("OTHER_THING")) {
			fromsupernew = true;
		}
	}
	...
	public static EMaterial fromMaterial(final Material mat) {
		if (cachedmaterial.containsKey(mat)) {
			return cachedmaterial.get(mat);
		}
		if (isNewVersion()) {
			for (EMaterial em : values()) {
				if (isNewVersion()) {
					if (em.toString().equals(mat.toString())) {
						cachedmaterial.put(mat, em);
						return em;
					}
				} else {
					for (String m : em.m) {
						if (m.equals(mat.toString())) {
							return em;
						}
					}
				}
		...
		EMaterial other = EMaterial.OTHER;
		other.m = new String[] { mat.toString() };
		return other;
	}

	public static EMaterial matching(final String name, final int data) {
		if (EMaterial.cachedstring.containsKey(name + ":" + data)) {
			return EMaterial.cachedstring.get(name + ":" + data);
		}
		for (EMaterial mat : values()) {
			if (mat.toString().equals(name) && mat.data == data) {
				cachedstring.put(name + ":" + data, mat);
				return matching(name, data);
			}
			for (String m : mat.m) {
				if (m.equals(name) && mat.data == data) {
					cachedstring.put(name + ":" + data, mat);
					return matching(name, data);
				}
			}
	...
	public static EMaterial fromString(String key) {
		...
		if (EMaterial.cachedstring.containsKey(key)) {
			return EMaterial.cachedstring.get(key);
		}
		if (key.startsWith("0") || key.startsWith("0:")) {
			EMaterial.cachedstring.put(key, EMaterial.AIR);
			return EMaterial.AIR;
		}
		boolean isid = !key.startsWith("0") && MathUT.strInt(key) > 0;
		boolean hasdata = key.contains(":");
		if (isid) {
			for (Material m : Material.values()) {
				if (m.getId() == MathUT.strInt(key)) {
					if (hasdata) {
						return matching(m.toString(), MathUT.strInt(key.split(":")[1]));
					}
					EMaterial.cachedstring.put(key, fromMaterial(m));
					return fromString(key);
				}
			}
			EMaterial.cachedstring.put(key, null);
			return null;
		} else {
			if (hasdata) {
				return matching(key, MathUT.strInt(key.split(":")[1]));
			} else {
				Material ma = Material.matchMaterial(key);
				if (ma != null) {
					EMaterial.cachedstring.put(key, fromMaterial(ma));
					return fromMaterial(ma);
				}
				for (EMaterial em : values()) {
					if (key.equals(em.toString())) {
						EMaterial.cachedstring.put(key, em);
						return em;
					}
					for (String m : em.m) {
						if (key.equals(m)) {
	...
	public Material parseMaterial() {
		Material mat = cachedematerial.getOrDefault(this, null);
		if (mat != null) {
			return mat;
		}
		if (!fromsupernew) {
			if (isNewVersion()) {
				...
				if (mat != null) {
					cachedematerial.put(this, mat);
					return mat;
				}
			}
		}
		for (String mm : m) {
			mat = Material.matchMaterial(mm);
			if (mat != null) {
				if (!fromsupernew) {
					cachedematerial.put(this, mat);
				}
	...
	public ItemStack parseItem() {
		if (cacheditemstack.containsKey(this)) {
			return cacheditemstack.get(this);
		}
		...
		if (isNewVersion()) {
			if (!fromsupernew) {
				cacheditemstack.put(this, new ItemStack(mat));
				return parseItem();
			}
			return new ItemStack(mat);
		}
		cacheditemstack.put(this, new ItemStack(mat, 1, (short) data));
		return parseItem();
	}

	public boolean isSameMaterial(final ItemStack comp) {
		if (cacheditemstack.containsKey(this)) {
			if (cacheditemstack.get(this).isSimilar(comp)) {
				return true;
			}
			return false;
		} else {
			cacheditemstack.put(this, parseItem());
			return isSameMaterial(comp);
		}
	}
	...
	public boolean isUnique() {
		if (EMaterial.cachedunique.containsKey(this)) {
			return EMaterial.cachedunique.get(this);
		}
		for (EMaterial mat : values()) {
			if (mat.m.equals(m) && mat.data > 0) {
				EMaterial.cachedunique.put(this, true);
				return true;
			}
		}
		EMaterial.cachedunique.put(this, false);
		return false;
	}
